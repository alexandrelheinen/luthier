...
def test_load_builtin_algorithms_populates_registry() -> None:
    ...
    assert "colmap_exhaustive_pairs" in registered_algorithms("reconstruction")
    assert "colmap_exhaustive_match" in registered_algorithms("reconstruction")
    assert "colmap_ransac" in registered_algorithms("reconstruction")
    assert "colmap_incremental" in registered_algorithms("reconstruction")
    assert "colmap_bundle_adjustment" in registered_algorithms("reconstruction")
    assert "colmap_triangulation" in registered_algorithms("reconstruction")
    assert "colmap_median_rgb" in registered_algorithms("reconstruction")
